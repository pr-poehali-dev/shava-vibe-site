      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-secondary/95 backdrop-blur">
        <div className="container mx-auto flex items-center justify-between py-4">
          <button onClick={() => scrollTo('hero')} className="flex items-center">
            <img src="https://cdn.poehali.dev/projects/0b080fae-f7ae-4739-bd77-49237a66845b/bucket/9eee1822-a020-470b-915a-f49786ad92c4.jpg" alt="ShavaVibe" className="h-12 w-12 rounded-full object-cover" />
          </button>
      ...
      <footer className="bg-secondary border-t border-primary/20">
        <div className="container mx-auto py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="https://cdn.poehali.dev/projects/0b080fae-f7ae-4739-bd77-49237a66845b/bucket/9eee1822-a020-470b-915a-f49786ad92c4.jpg" alt="ShavaVibe" className="h-10 w-10 rounded-full object-cover" />
